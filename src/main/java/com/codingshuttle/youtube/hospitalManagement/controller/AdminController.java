...
public class AdminController {
    ...
    public ResponseEntity<DoctorResponseDto> onBoardNewDoctor(@RequestBody onBoardNewRequestDto onboardnewrequestdto){
 return ResponseEntity.status(HttpStatus.CREATED).body(doctorService.onBoardNewDoctor(onboardnewrequestdto));
    }
}
